...
(function (b) {
    ...
    b.fn.editableform.defaults = {type: "text", url: null, params: null, name: null, pk: null, value: null, send: "auto", validate: null, success: null, error: null, ajaxOptions: null, showbuttons: true, scope: null, savenochange: false};
    ...
    a.fn.editableutils = {inherit: function (c, b) {
        ...
        a.each(f, function (h, j) {
            if (j.children) {
                ...
                if (c) {
                    if (a.grep(g,function (i) {
                        return i == (j && typeof j === "object" ? j[d] : j)
                    }).length) {
                        b.push(j)
                    }
                } else {
...
(function (c) {
    ...
    b.prototype = {containerName: null, innerCss: null, containerClass: "editable-container editable-popup", init: function (e, d) {
        this.$element = c(e);
        ...
        var c = function (e, f) {
            if (a.isArray(f)) {
                for (var d = 0; d < f.length; d++) {
                    if (f[d].children) {
                        e.append(c(a("<optgroup>", {label: f[d].text}), f[d].children))
                    } else {
                        e.append(a("<option>", {value: f[d].value}).text(f[d].text))
                    }
                }
            }
            return e
...
(function (b) {
    ...
    b.extend(a.prototype, {renderList: function () {
        ...
        for (var e = 0; e < this.sourceData.length; e++) {
            c = b("<label>").append(b("<input>", {type: "checkbox", value: this.sourceData[e].value})).append(b("<span>").text(" " + this.sourceData[e].text)).addClass("lbl");
...
(function (a) {
    var b = function (c) {
        ...
        this.sourceData = null;
        if (c.placeholder) {
            c.select2.placeholder = c.placeholder
        }
        if (!c.select2.tags && c.source) {
            var d = c.source;
            if (a.isFunction(c.source)) {
                d = c.source.call(c.scope)
            }
            if (typeof d === "string") {
                c.select2.ajax = c.select2.ajax || {};
                if (!c.select2.ajax.data) {
                    c.select2.ajax.data = function (e) {
                        return{query: e}
                    }
                }
                if (!c.select2.ajax.results) {
                    c.select2.ajax.results = function (e) {
                        return{results: e}
                    }
                }
    ...
    a.extend(b.prototype, {render: function () {
        ...
        if (this.options.select2.tags) {
            ...
            if (this.sourceData) {
                d = a.fn.editableutils.itemsByValue(e, this.sourceData, "id")
            } else {
            }
        }
        if (a.isArray(d)) {
        ...
        if (this.isRemote) {
            var d, c;
            if (this.sourceData) {
                c = a.fn.editableutils.itemsByValue(e, this.sourceData, "id");
                if (c.length) {
                    d = c[0]
                }
            }
            if (!d) {
                d = {id: e, text: a(this.options.scope).text()}
            }
            this.$input.select2("data", d).trigger("change", true)
        } else {
...
(function (a) {
    a.extend(a.fn.editableContainer.Popup.prototype, {containerName: "popover", innerCss: a.fn.popover && a(a.fn.popover.defaults.template).find("p").length ? ".popover-content p" : ".popover-content", initContainer: function () {
        a.extend(this.containerOptions, {trigger: "manual", selector: false, content: " ", template: a.fn.popover.defaults.template});
        var b;
        ...
        (function () {
            ...
            b = /in/.test(c);
            f.removeClass("top right bottom left").css({top: 0, left: 0, display: "block"});
            h = this.getPosition(b);
            d = f[0].offsetWidth;
            g = f[0].offsetHeight;
            switch (b ? c.split(" ")[1] : c) {
                case"bottom":
                    e = {top: h.top + h.height, left: h.left + h.width / 2 - d / 2};
                    break;
                case"top":
                    e = {top: h.top - g, left: h.left + h.width / 2 - d / 2};
                    break;
                case"left":
                    e = {top: h.top + h.height / 2 - g / 2, left: h.left - d};
                    break;
                case"right":
                    e = {top: h.top + h.height / 2 - g / 2, left: h.left + h.width};
                    break
            }
...
(function (g) {
    ...
    h.prototype = {constructor: h, _process_options: function (n) {
        ...
        if (this.isInput) {
            this._events = [
                [this.element, {focus: g.proxy(this.show, this), keyup: g.proxy(this.update, this), keydown: g.proxy(this.keydown, this)}]
            ]
        } else {
            if (this.component && this.hasInput) {
                this._events = [
                    [this.element.find("input"), {focus: g.proxy(this.show, this), keyup: g.proxy(this.update, this), keydown: g.proxy(this.keydown, this)}],
                    [this.component, {click: g.proxy(this.show, this)}]
                ]
            } else {
                if (this.element.is("div")) {
                    ...
                    this._events = [
                        [this.element, {click: g.proxy(this.show, this)}]
                    ]
                }
            }
        }
        this._secondaryEvents = [
            [this.picker, {click: g.proxy(this.click, this)}],
            [g(window), {resize: g.proxy(this.place, this)}],
            [g(document), {mousedown: g.proxy(function (n) {
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.date.defaults, {tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>', inputclass: "input-small", datepicker: {weekStart: 0, startView: 0, minViewMode: 0, autoclose: true}});
...
(function (b) {
    ...
    a.defaults = b.extend({}, b.fn.editabletypes.datetime.defaults, {tpl: '<div class="input-append date"><input type="text"/><span class="add-on"><i class="icon-th"></i></span></div>', inputclass: "input-medium", datetimepicker: {todayHighlight: false, autoclose: true}});

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Branch'
        db.create_table(u'internal_branch', (
            ...
            ('branch_manager', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='branch_employee', unique=True, null=True, to=orm['auth.User'])),
            ...
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=13, null=True, blank=True)),
        ))
        db.send_create_signal(u'internal', ['Branch'])

        # Adding model 'Branch_Pincode'
        db.create_table(u'internal_branch_pincode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('on_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='branch_pincodes', to=orm['internal.Branch'])),
            ('pincode', self.gf('django.db.models.fields.related.OneToOneField')(related_name='branch_pincode', unique=True, to=orm['zoning.Pincode'])),
        ))
        db.send_create_signal(u'internal', ['Branch_Pincode'])

        # Adding model 'Employee'
        db.create_table(u'internal_employee', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('on_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='profile', unique=True, to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='employee_branch', null=True, to=orm['internal.Branch'])),
        ...
        db.send_create_signal(u'internal', ['Employee'])

        # Adding model 'Vehicle'
        db.create_table(u'internal_vehicle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('on_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('vehicle_no', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('vehicle_type', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('driver_name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('branch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['internal.Branch'])),
        ))
        db.send_create_signal(u'internal', ['Vehicle'])


    def backwards(self, orm):
        # Deleting model 'Branch'
        db.delete_table(u'internal_branch')

        # Deleting model 'Branch_Pincode'
        db.delete_table(u'internal_branch_pincode')

        # Deleting model 'Employee'
        db.delete_table(u'internal_employee')

        # Deleting model 'Vehicle'
        db.delete_table(u'internal_vehicle')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vehicle.branch'
        db.alter_column(u'internal_vehicle', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['internal.Branch'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Vehicle.branch'
        raise RuntimeError("Cannot reverse this migration. 'Vehicle.branch' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Vehicle.branch'
        db.alter_column(u'internal_vehicle', 'branch_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['internal.Branch']))

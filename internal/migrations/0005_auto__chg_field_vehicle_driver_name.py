...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vehicle.driver_name'
        db.alter_column(u'internal_vehicle', 'driver_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Vehicle.driver_name'
        raise RuntimeError("Cannot reverse this migration. 'Vehicle.driver_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Vehicle.driver_name'
        db.alter_column(u'internal_vehicle', 'driver_name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

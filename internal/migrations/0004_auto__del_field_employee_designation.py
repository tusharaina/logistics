...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Employee.designation'
        db.delete_column(u'internal_employee', 'designation')


    def backwards(self, orm):
        # Adding field 'Employee.designation'
        db.add_column(u'internal_employee', 'designation',

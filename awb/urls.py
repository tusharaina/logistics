...
urlpatterns = patterns('awb.views',
                       ...
                       url(r'^awb/collected_cash/awb$', 'collected_cod', name='collected_cod'),
                       ...
                       url(r'^awb/serializer/(\d+)$', 'awb_list', name='awb_list'),
                       url(r'^awb/mobile/(\d+)$', 'awb_history_mobile', name='awb_history_mobile'),

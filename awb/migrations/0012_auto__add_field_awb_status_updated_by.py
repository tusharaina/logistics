...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AWB_Status.updated_by'
        db.add_column(u'awb_awb_status', 'updated_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AWB_Status.updated_by'
        db.delete_column(u'awb_awb_status', 'updated_by_id')

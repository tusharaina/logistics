...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AWB.barcode'
        db.add_column(u'awb_awb', 'barcode',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AWB.barcode'
        db.delete_column(u'awb_awb', 'barcode')
    ...
    models = {
        ...
        u'awb.awb': {
            ...
            'barcode': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),

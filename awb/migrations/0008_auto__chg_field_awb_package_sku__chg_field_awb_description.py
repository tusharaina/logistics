...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AWB.package_sku'
        db.alter_column(u'awb_awb', 'package_sku', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'AWB.description'
        db.alter_column(u'awb_awb', 'description', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'AWB.package_sku'
        db.alter_column(u'awb_awb', 'package_sku', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

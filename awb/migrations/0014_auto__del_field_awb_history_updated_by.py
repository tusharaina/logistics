...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AWB_History.updated_by'
        db.delete_column(u'awb_awb_history', 'updated_by_id')


    def backwards(self, orm):
        # Adding field 'AWB_History.updated_by'
        db.add_column(u'awb_awb_history', 'updated_by',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AWB_History.branch'
        db.add_column(u'awb_awb_history', 'branch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['internal.Branch'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AWB_History.branch'
        db.delete_column(u'awb_awb_history', 'branch_id')

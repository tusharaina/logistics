...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'awb_awb', (
            ...
            ('package_sku', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ...
            ('preferred_pickup_date', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('preferred_pickup_time', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
        ))
        ...
        db.create_table(u'awb_awb_status', (
            ...
            ('on_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('awb', self.gf('django.db.models.fields.related.OneToOneField')(related_name='awb_status', unique=True, to=orm['awb.AWB'])),
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='DR', max_length=3)),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AWB_History.status'
        db.alter_column(u'awb_awb_history', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))

    def backwards(self, orm):

        # Changing field 'AWB_History.status'
        db.alter_column(u'awb_awb_history', 'status', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
    ...
    models = {
        ...
        u'awb.awb_history': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),

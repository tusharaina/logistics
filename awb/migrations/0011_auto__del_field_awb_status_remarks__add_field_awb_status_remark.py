...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AWB_Status.remarks'
        db.delete_column(u'awb_awb_status', 'remarks')

        # Adding field 'AWB_Status.remark'
        db.add_column(u'awb_awb_status', 'remark',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AWB_Status.remarks'
        db.add_column(u'awb_awb_status', 'remarks',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'AWB_Status.remark'
        db.delete_column(u'awb_awb_status', 'remark')
    ...
    models = {
        ...
        u'awb.awb_status': {
            ...
            'on_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'reason': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'remark': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
